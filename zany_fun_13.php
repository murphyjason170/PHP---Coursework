...
function set_cookie()
{
	?>
	<script>
		alert("set_cookie function called");
	</script>
	<?
	
 	$value = $_POST['name'];			# Does not work
        # $value = "my cookie value";		# Works
	setcookie("name",$value, time()+3600*24);

	$value_2 = $_POST['wookie'];
	setcookie("janky", $value_2, time()+3600*24);
}
...
function register_first()
{
	...
	<form action="" method="post">
  	...
  	<input type="text" size="25" name="wookie" value="wackachaka" />

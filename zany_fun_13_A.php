...
{
	echo "<h3>You have already downloaded this file!</h3><br/>";	
	exit();
}
...
function set_cookie()
{
	...
	# Force the page to reload now that the cookie is set
	?>
...
{
	$value_of_download = 'yes';
	setcookie("downloaded", $value_of_download, time()+3600*24);
	?>
	<script>
		alert("set_cookie_downloaded function has been called")
	</script>
	<?
}
...
function download_software() 
{
	...
	echo '<input type="submit" name="submit_2" value="Download The File!" />';
	echo '</form>';
 	echo '<br/>';
	echo "</body>";
